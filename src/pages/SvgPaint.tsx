...
const SvgPaint: React.FC = () => {
  const [fillColor, setFillColor] = useState("#aefdca");
  ...
  const downloadAsPNG = async () => {
    ...
    try {
      ...
      link.download = `${selectedPath.getAttribute("id") || "path"}.png`;
  ...
  return (
    <Box p="xl">
      <Paper shadow="md" radius="md" p="md" mb="lg" withBorder>
        <Stack>
          <Title order={2} mb="md">
            Xaritani bo'yash
          </Title>
