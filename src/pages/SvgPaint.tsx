...
const SvgPaint: React.FC = () => {
  ...
  return (
    <Box p="md">
      <Box mb="md" style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
        <div>
